...
{
    /// <inheritdoc />
    public partial class CakeWebSite : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CakeOrders", x => x.CakeId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CakeOrders_Fillings_FillingId",
                        column: x => x.FillingId,
                        principalTable: "Fillings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CakeOrders_Order_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CakeOrders_FillingId",
                table: "CakeOrders",
                column: "FillingId");

            migrationBuilder.CreateIndex(
                name: "IX_CakeOrders_OrderId",
                table: "CakeOrders",
                column: "OrderId");
